    ...
    >
      ...
      <div id="form" class="flex flex-col space-y-2 space-x-2 md:space-x-0">
        ...
        <button
          ...
          id="addButton"
          label="Add to cart"
          class="p-4 lg:p-0 bg-[#0d0d0d] rounded-full hover:opacity-90 font-inter border-y-4 border-[#00000000] disabled:opacity-20 disabled:hover:border-[#ff007a00] relative drop-shadow-[0_4.3px_1.4px_rgba(0,0,0,0.6)]"
