...
onMounted(() => {
  const deliveryInfoInputs = Array.from(
    deliveryInfo.value.getElementsByTagName("input"),
  );
  ...
  deliveryInfoInputs.forEach((input) => {
    input.addEventListener("keyup", () => {
      ...
      if (isFieldsetComplete.value === true) {
        ...
        if (
          shippingMethodFieldset.querySelector(
  ...
  paymentMethodFieldset
    ...
    .forEach((radioButton) => {
      radioButton.addEventListener("click", () => {
        if (
          paymentMethodFieldset.querySelector(
      ...
      >
          ...
          <fieldset id="deliveryInfo" ref="deliveryInfo" class="text-[#0c0c0c]">
            ...
            >
              <div id="button-contents" class="relative p-1.5">
                <p class="inline">
                  Add c/o-adress <span class="text-xl font-bold">+</span>
                </p>
              </div>
            </button>
            <button
            ...
            >
              <div id="button-contents" class="relative p-1.5">
                <p class="inline">
                  Remove c/o-adress <span class="text-xl font-bold">-</span>
                </p>
              </div>
            </button>
          </fieldset>
        ...
        >
          <div class="bg-[#1c1c1c] p-1">
            ...
            <div
              id="cart-cards-container"
              class="lg:overflow-y-auto lg:max-h-[834px]"
            >
              <CartCards />
            </div>
          ...
          <fieldset id="shippingMethod" :disabled="shipFieldsetDisabled">
            ...
            <div>
              ...
              >
                ...
                <img
                  src="/src/assets/shipping/postnord-logo.png"
                  alt=""
              ...
              <div
                class="flex flex-row items-center border-solid border-[#2a2a2a] border-x-2"
              >
                <input
                  id="instabox"
                  type="radio"
                ...
                <img
                  src="/src/assets/shipping/Instabox-logo.jpg"
                  alt=""
                  class="h-16 w-28 object-cover inline ml-auto"
                  :class="{ 'filter grayscale': shipFieldsetDisabled }"
                />
              ...
              >
                ...
                <img
                  src="/src/assets/shipping/dhl-logo.png"
                  alt=""
                  class="h-16 w-28 object-cover inline ml-auto"
                  :class="{ 'filter grayscale': shipFieldsetDisabled }"
                />
          ...
          <fieldset id="paymentMethod" :disabled="payFieldsetDisabled">
            ...
            <div>
              ...
              >
                ...
                <img
                  src="/src/assets/payment/swish-logo.jpg"
                  alt=""
                  class="h-16 w-28 object-cover inline ml-auto"
              ...
              >
                ...
                <img
                  src="/src/assets/payment/klarna-logo.jpg"
                  alt=""
                  class="h-16 w-28 object-cover inline ml-auto"
                  :class="{ 'filter grayscale': payFieldsetDisabled }"
                />
              ...
              <div
                class="flex flex-row items-center border-solid border-[#2a2a2a] border-x-2 border-t-2"
              >
                <input
                  id="masterCard"
                  type="radio"
                ...
                <img
                  src="/src/assets/payment/mastercard-logo.svg"
                  alt=""
              ...
              >
                ...
                <img
                  src="/src/assets/payment/visa-logo.jpg"
                  alt=""
                  class="h-16 w-28 object-cover inline ml-auto"
                  :class="{ 'filter grayscale': payFieldsetDisabled }"
                />
      ...
      >
        <fieldset id="confirmPayment" :disabled="confirmFieldsetDisabled">
          <input
            ...
            id="newsLetter"
            name="News Letter"
            class="mr-3 size-5 align-middle"
          />
          <label for="newsLetter" class="align-middle text-sm"
            >Sign up to our news letter!</label
          >
          <p class="pt-6 font-semibold text-lg">
